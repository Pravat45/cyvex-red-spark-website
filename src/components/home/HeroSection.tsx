        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="relative z-10">
            <div className="inline-flex items-center bg-cyvex/10 text-cyvex px-4 py-1.5 rounded-full mb-6">
              ...
              <span className="text-sm font-medium">Trusted Cybersecurity Solutions</span>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button asChild size="lg" className="bg-cyvex hover:bg-cyvex-dark">
          ...
          <div className="relative hidden md:block">
            ...
            <div className="relative bg-white p-6 rounded-xl shadow-xl border border-gray-100">
              <div className="aspect-video bg-gray-100 rounded-lg flex items-center justify-center mb-6">
                <ShieldCheck size={80} className="text-cyvex opacity-20" />
              </div>
